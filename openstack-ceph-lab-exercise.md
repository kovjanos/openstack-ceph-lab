...
The exercises are sized for a **24 GB machine**, the documented minimum. That leaves
roughly 13 GB for guests once Ceph and the OpenStack control plane have taken their
share, and Ceph gives **14 GiB usable** after 3× replication.

| | |
|---|---|
| Lab guest | 512 MB RAM, 248 MB image — every workload exercise uses the same one |
| Concurrent guests | 3-4 on a 24 GB machine, more on 28-32 GB |
