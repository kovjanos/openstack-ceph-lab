# Exercise 20 — Lose a disk while the service is running (web UI)

Guide section: [Exercise 20](../openstack-ceph-lab-exercise.md#exercise-20--lose-a-disk-while-the-service-is-running)
...
![Ceph OSDs list with the action bar](img/ex20-step01-ceph-osds-list.png)
...
- **Scrub** / **Deep Scrub** — Exercise 24
- **Reweight** — Exercise 21
