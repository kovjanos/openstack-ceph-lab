# Exercise 15 — Ceph maintenance mode (web UI)

Guide section: [Exercise 15](../openstack-ceph-lab-exercise.md#exercise-15--ceph-maintenance-mode)
...
![Ceph hosts list with the actions menu](img/ex15-step01-ceph-hosts-list.png)
...
The other two entries matter for Exercise 23. **Start Drain** moves daemons off a host
...
![Cluster-wide OSD flags](img/ex15-step02-cluster-wide-osd-flags.png)
