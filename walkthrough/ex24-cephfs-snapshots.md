# Exercise 24 — Filesystem snapshots that cost nothing (web UI)

Guide section: [Exercise 24](../openstack-ceph-lab-exercise.md#exercise-24--filesystem-snapshots-that-cost-nothing)
...
![CephFS snapshots tab](img/ex24-step01-cephfs-snapshots-tab.png)
