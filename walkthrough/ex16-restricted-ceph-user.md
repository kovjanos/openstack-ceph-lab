# Exercise 16 — Scoping credentials with a restricted Ceph user (web UI)

Guide section: [Exercise 16](../openstack-ceph-lab-exercise.md#exercise-16--scoping-credentials-with-a-restricted-ceph-user)
...
![Ceph users and capabilities](img/ex16-step01-ceph-users-capabilities.png)
