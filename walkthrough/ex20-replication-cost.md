# Exercise 20 — What replication actually costs you (web UI)

Guide section: [Exercise 20](../openstack-ceph-lab-exercise.md#exercise-20--what-replication-actually-costs-you)
...
![Ceph pools list](img/ex20-step01-ceph-pools-list.png)
...
45 GiB cluster — which is how Exercise 24's cluster fills up, and why this lab builds a
