# Exercise 27 — The monitoring you already have (web UI)

Guide section: [Exercise 27](../openstack-ceph-lab-exercise.md#exercise-27--the-monitoring-you-already-have)
...
![Ceph dashboard overview](img/ex27-step01-ceph-dashboard-overview.png)
...
![Services showing the monitoring stack](img/ex27-step05-services-monitoring-stack.png)
...
![Hosts overall performance](img/ex27-step03-hosts-overall-performance-grafana.png)
...
![OSDs overall performance](img/ex27-step04-osds-overall-performance-grafana.png)
...
![Pools overall performance](img/ex27-step10-pools-overall-performance-grafana.png)
...
![Grafana pre-built dashboards](img/ex27-step09-grafana-prebuilt-dashboards.png)
...
![Prometheus targets](img/ex27-step08-prometheus-targets.png)
...
![Active alerts](img/ex27-step06-observability-alerts.png)
...
![Alert rules](img/ex27-step07-alert-rules-list.png)
...
caught [Exercise 29](ex29-full-cluster.md) while the cluster was still writable, rather
...
![Ceph cluster logs](img/ex27-step02-ceph-cluster-logs.png)
...
Re-run the [Exercise 22](ex22-lose-a-disk.md) failure drill with **Cluster → OSDs**
