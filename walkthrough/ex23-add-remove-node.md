# Exercise 23 — Add a node, then take it away again (web UI)

Guide section: [Exercise 23](../openstack-ceph-lab-exercise.md#exercise-23--add-a-node-then-take-it-away-again)
...
![Add host dialog](img/ex23-step01-ceph-add-host-dialog.png)
...
![Hosts list with the actions menu](img/ex15-step01-ceph-hosts-list.png)
